...
(function (root, factory) {
  ...
  var TYPES = {
    ...
    Projector: {
      ...
      notSelf: 'Bitterness. Read as the signal of having entered without invitation, or of having gone unrecognised for too long.',
  ...
  function centerOf(gate) { var g = GATES[gate]; return g ? g[1] : null; }
  ...
  var TERMS = [
    { name: 'Bodygraph', text: 'The diagram itself: nine centers, 36 channels and 64 gates, with the Personality activations printed in black on one side and the Design activations in red on the other. Everything the system says is read off this one picture.' },
    ...
    { name: 'Color, Tone and Base', text: 'Gate and line are the first two layers of the system’s address for a position; colour, tone and base are the three finer ones beneath them, and they are what the Variables are derived from. Ra Uru Hu’s full notation is gate.line.colour.tone.base. This build reads to gate and line only.' },
  ...
  return { VERSION: VERSION, INTRO: INTRO, TYPES: TYPES, LINES: LINES, PROFILES: PROFILES,
    ...
    GATES: GATES, DEFINITION: DEFINITION, CROSS: CROSS, CIRCUITS: CIRCUITS, TERMS: TERMS,
    EXAMPLE: EXAMPLE, SECTIONS: SECTIONS,
