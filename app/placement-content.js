...
(function () {
  ...
  var EXPANDED = {
    ...
    /* trans-Neptunian objects and dwarf astral bodies: slow, so a placement is
    ...
    eris: { label: 'Eris', kind: 'tno', energy: 'discord that exposes what was hidden',
      definition: 'Eris is the Greek goddess of strife. Left off the guest list for a wedding of the gods, she threw in a golden apple marked for the fairest, and the quarrel it started led to the Trojan War. The dwarf astral body, found in 2005, is almost exactly Pluto’s size, and its discovery is what led astronomers to redefine what an astral body is.',
    ...
    haumea: { label: 'Haumea', kind: 'tno', energy: 'fertility and self renewal',
      definition: 'Haumea is the Hawaiian goddess of childbirth and fertility, who in legend gave birth to many children from different parts of her body and renewed herself to stay young. The dwarf astral body, found in 2004, spins so fast it is stretched into an egg shape, has two moons named for her daughters, and has a family of fragments broken off by an ancient collision.',
    ...
    makemake: { label: 'Makemake', kind: 'tno', energy: 'creation, ritual and ecological abundance',
      definition: 'Makemake is the creator god of Rapa Nui, Easter Island, and the god of fertility at the centre of the Birdman ritual in which men raced to bring back the first egg of the season. The dwarf astral body was found just after Easter in 2005, which is how it came by the name.',
