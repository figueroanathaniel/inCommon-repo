...
(function (root, factory) {
  ...
  /* ---------- Stella grounding (audit B6 + amendment 5: chips resolve to real enabled source IDs) ---------- */
  // Source IDs are the stellaCtx scope keys. 'scripted' and 'safety' are always legal.
  var SOURCE_REGISTRY = [
