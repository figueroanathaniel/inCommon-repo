...
**Throughline.** Timeline of journal entries, mood, practices, Synchronicities
...
| `angel-numbers.js` | Angel number library, the number half of Synchronicities |
| `animal-symbolism.js` | Animal sighting readings, the other half of Synchronicities |
